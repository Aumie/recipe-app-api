...
class PrivateRecipeAPITests(TestCase):
    ...
    def test_retrieve_recipe(self):
        """Test recieving a list of recipe"""
    ...
    def test_partial_update(self):
        ...
        self.assertEqual(res.status_code, status.HTTP_200_OK)
        # db doesnt refresh from default
    ...
    def test_full_update(self):
        ...
        payload = {
            ...
            'link': 'https://emaple.com/new-recipe.pdf',
    ...
    def test_user_unable_to_reassign_user(self):
        """Test changeing the recipe user results in error"""
    ...
    def test_create_tag_on_update(self):
        ...
        # if many to many, no need to refresh db
    ...
    def test_create_recipe_with_existing_ingredietns(self):
    ...
    def test_filter_by_tags(self):
        ...
        r1 = create_recipe(user=self.user, title='Thai VegetableCurry')
...
class ImageUploadTests(TestCase):
    ...
    def test_upload_image(self):
        ...
        with tempfile.NamedTemporaryFile(suffix='.jpg') as image_file:
            ...
            # if not seek 0 in will start reading at the end of the file
            image_file.seek(0)
